...
function handleDragEnd(event) {
    ...
    setTimeout(() => {
        if (draggedElement && draggedElement.classList.contains('dragging')) {
           ...
           console.log(`handleDragEnd: Fjernet .dragging fra draggedElement (id: ${endedDragPlayerId})`);
        }
        if (endedDragPlayerId && playersOnPitch[endedDragPlayerId]) {
            ...
            if (pieceOnPitch && pieceOnPitch.classList.contains('dragging')) {
                 ...
                 console.log(`handleDragEnd: Fjernet .dragging fra piece on pitch (id: ${endedDragPlayerId})`);
            }
        }
        ...
        resetDragState();
        console.log(`handleDragEnd: Tilstand nullstilt (etter drag av ${endedDragPlayerId})`);
    }, 0);
}
